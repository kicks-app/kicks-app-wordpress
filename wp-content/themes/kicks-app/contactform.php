<div class="bcf mt-4">
  ...
  <?php else: ?>
    <?php if ($title): ?>
      <h2 class="bcf-title text-primary"><i class="fas fa-hand-point-right"></i>&nbsp;<?= $title ?></h2>
    <?php endif; ?>
    <?php if ($description): ?>
      ...
      <form class="bcf-form" method="POST">
        <?php if (in_array('name', $fields)) : ?>
          <p class="bcf-field form-group">
            <label class="bcf-label font-weight-bold">
        ...
        <?php if (in_array('subject', $fields)) : ?>
          <p class="bcf-field form-group">
            <label class="bcf-label font-weight-bold"><?= __('Subject', 'basic-contact-form') ?><?= in_array('subject', $required) ? '*' : ''; ?></label>
